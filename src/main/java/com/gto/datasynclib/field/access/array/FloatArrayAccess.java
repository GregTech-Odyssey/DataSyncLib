...
/**
 * Synchronizes an {@code float[]} primitive array with <strong>in-place</strong> mutation.
 *
 * <h3>Change detection:</h3>
 * <p>Uses {@link Arrays#hashCode(float[])} for fast content-based change detection.
...
public final class FloatArrayAccess extends AbstractFieldAccess<float[]> {
    ...
    @Override
    protected boolean hasChange(@NotNull LogicalSide side, float @NotNull [] instance, boolean autoOnly) {
