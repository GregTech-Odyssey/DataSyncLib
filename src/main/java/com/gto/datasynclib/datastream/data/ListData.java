...
/**
 * Represents a list of Data elements in the Data type system. Wire format ID: 13.
 * Provides typed add methods for all primitive types.
 */
public record ListData(List<Data> value) implements CollectionData, Iterable<Data> {
    ...
    public boolean equals(Object obj) {
        return this == obj || (obj instanceof ListData(
                List<Data> value1
